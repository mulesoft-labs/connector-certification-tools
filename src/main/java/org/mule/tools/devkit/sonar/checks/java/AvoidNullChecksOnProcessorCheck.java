...
public class AvoidNullChecksOnProcessorCheck extends AbstractConnectorClassCheck {
    ...
    private static final List<String> ANNOTATION_CLASSES = Lists.newArrayList("org.jetbrains.annotations.Nullable", "org.jetbrains.annotations.NotNull",
            "com.sun.javafx.beans.annotations.NonNull", "javax.annotation.Nonnull");
