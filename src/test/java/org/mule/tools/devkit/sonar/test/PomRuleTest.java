...
public class PomRuleTest {
    ...
    @Test
    public void testFrameworkOverwrite() throws IOException {
    ...
    @Test
    public void testFrameworkOverwriteOk() throws IOException {
        final Rule rule = TestData.findRule("ctf_version_overwritten");
    ...
    @Test
    public void testDistributionManagementOk() throws IOException {
    ...
    @Test
    public void testDevKitVersionOk() throws IOException {
    ...
    @Test
    public void testDevKitVersionWrong() throws IOException {
        final Rule rule = TestData.findRule("devkit_version");
        final Path rootPath = TestData.noCompliantTestPath();
        final Path childPath = Paths.get("pom.xml");
